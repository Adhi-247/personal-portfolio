  ...
  const contactInfo = [
    {
      icon: <FiMail />,
      title: "Email",
      value: "adeeshaprabashwarasenarath7@gmail.com",
      link: "mailto:adeeshaprabashwarasenarath7@gmail.com"
    },
    {
      icon: <FiMapPin />,
      title: "Location",
    ...
    },
    {
      icon: <FiPhone />,
      title: "Phone",
      value: "+94 71 106 3357",
      link: "tel:+94711063357"
    }
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-4 mt-8">
              {[
                { icon: <FiGithub />, url: "https://github.com/Adhi-247" },
                { icon: <FiLinkedin />, url: "https://www.linkedin.com/in/adeesha-prabashwara-549464386/" },
                { icon: <FiTwitter />, url: "#" }
              ].map((social, index) => (
                <motion.a
                  key={index}
