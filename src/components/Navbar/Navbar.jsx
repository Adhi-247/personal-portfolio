    ...
    >
      <div className="text-white py-5 flex justify-between items-center">
        ...
        >
          ...
          <span className="text-white">adeesha</span>
          <span className="text-[#8245ec]">/</span>
          <span className="text-white">prabashwara</span>
          <span className="text-[#8245ec]">&gt;</span>
        </motion.div>
        ...
        <div className="hidden md:flex space-x-4">
          <motion.a
            href="https://github.com/Adhi-247"
            target="_blank"
          ...
          <motion.a
            href="https://www.linkedin.com/in/adeesha-prabashwara-549464386/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-[#8245ec]"
            whileHover={{ scale: 1.2, color: "#8245ec" }}
