...
import profileImage from '../../assets/Adeeshaprabashwara.JPG';
      ...
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
          ...
          <p className="text-base sm:text-lg md:text-lg text-gray-400 mb-10 mt-8 leading-relaxed">
            Software Engineering student at SLIIT specializing in full-stack and 
            mobile development. I build scalable web applications with the MERN stack 
            and create user-friendly mobile apps using React, Node.js, Java, and Python. 
            Passionate about problem-solving and eager to contribute to innovative projects.
          </p>
          {/* Resume Button */}
          <a
            href="https://drive.google.com/file/d/14ggwNAwukexvDuIjsBWY8NnCckhVZ7z6/view?usp=sharing"
            target="_blank"
